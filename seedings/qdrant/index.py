...
for page_metadata_point in PAGE_METADATA_POINTS:
    metadata = (
        ...
        f"Keywords: {", ".join(page_metadata_point.payload.keywords)}.\n"
        f"Description: {page_metadata_point.payload.description}."
    )
...
for faq_metadata_point in FAQ_METADATA_POINTS:
    metadata = (
        ...
        f"Keywords: {", ".join(faq_metadata_point.payload.keywords)}.\n"
